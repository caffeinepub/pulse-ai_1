...
const MOCK_JWT = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyXzEyMyIsInVzZXJuYW1lIjoiYWtoaWxlc2giLCJpYXQiOjE3MDAwMDAwMDAsImV4cCI6MTcwMDAwMzYwMH0.mock_signature_pulse_ai";
const PICSUM_SEEDS = [
  "aurora",
  "nebula",
  "cosmos",
...
async function generateSpark(prompt, style2) {
  ({
    headers: {
...
function PulseWaveLogo({
  ...
  const waveformPath = "M 10 50 L 38 50 L 38 20 Q 38 10 50 10 Q 62 10 62 22 Q 62 34 50 34 L 38 34 L 38 50 L 58 50 L 68 20 L 78 80 L 88 10 L 98 70 L 110 50 L 190 50";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Pulse Wave Logo" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("filter", { id: "neon-glow", x: "-50%", y: "-50%", width: "200%", height: "200%", children: [
...
function AuthScreen({ onSuccess }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center bg-app-dark px-4 overflow-y-auto scrollbar-hide", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse 80% 50% at 50% 30%, rgba(138,43,226,0.08) 0%, transparent 65%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          ...
          boxShadow: "0 0 40px rgba(138,43,226,0.15), 0 0 80px rgba(138,43,226,0.05), inset 0 0 0 1px rgba(138,43,226,0.1)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PulseWaveLogo, { size: "small" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      background: mode === "login" ? "linear-gradient(135deg, #8A2BE2 0%, #6F00FF 100%)" : "transparent",
                      color: mode === "login" ? "#ffffff" : "#7070a0",
                      border: mode === "login" ? "none" : "1px solid rgba(138,43,226,0.3)"
                    },
                    children: "Login"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: "flex-1 py-2 rounded-lg font-outfit font-semibold text-sm transition-all duration-200",
                    style: {
                      background: mode === "signup" ? "linear-gradient(135deg, #8A2BE2 0%, #6F00FF 100%)" : "transparent",
                      color: mode === "signup" ? "#ffffff" : "#7070a0",
                      border: mode === "signup" ? "none" : "1px solid rgba(138,43,226,0.3)"
                    },
                    children: "Sign Up"
                  }
                )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onFocus: (e) => {
                    ...
                    e.target.style.boxShadow = "0 0 0 1px rgba(138,43,226,0.3), 0 0 12px rgba(138,43,226,0.15)";
                  },
                  onBlur: (e) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  background: isLoading ? "linear-gradient(135deg, rgba(138,43,226,0.5) 0%, rgba(111,0,255,0.5) 100%)" : "linear-gradient(135deg, #8A2BE2 0%, #6F00FF 100%)",
                ...
                onMouseEnter: (e) => {
                  if (!isLoading) {
                    ...
                    e.target.style.boxShadow = "0 6px 28px rgba(138,43,226,0.6)";
                  }
                },
                onMouseLeave: (e) => {
                  e.target.style.filter = "";
                  e.target.style.boxShadow = "0 4px 20px rgba(138,43,226,0.4)";
                },
                children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center justify-center gap-2", children: [
                  ...
                  mode === "login" ? "Entering the Nexus..." : "Joining the Pulse..."
                ] }) : mode === "login" ? "Enter the Nexus" : "Join the Pulse"
              }
            )
          ] })
        ]
...
function MasonryItem({ item, index: index2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": `explore.grid.item.${index2 + 1}`,
      ...
      children: [
        ...
        item.isVideo && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-black/50 rounded-full p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-4 h-4 text-white fill-white" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        item.isVideo && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-2.5 h-2.5 text-white fill-white" })
          }
        )
      ]
    }
...
function ExploreTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-full", children: [
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              border: isFocused ? "1px solid rgba(138,43,226,0.7)" : "1px solid rgba(138,43,226,0.3)",
              boxShadow: isFocused ? "0 0 0 2px rgba(138,43,226,0.18), 0 0 20px rgba(138,43,226,0.12)" : "none"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Search,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    background: isFocused ? "rgba(138,43,226,0.2)" : "rgba(138,43,226,0.08)",
                    border: "1px solid rgba(138,43,226,0.35)",
                    boxShadow: isFocused ? "0 0 8px rgba(138,43,226,0.3)" : "none"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3 h-3", style: { color: "#8A2BE2" } }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                ...
                border: isActive ? "1px solid #8A2BE2" : "1px solid rgba(138,43,226,0.45)",
                color: isActive ? "#ffffff" : "#d1d5db",
                boxShadow: isActive ? "0 0 12px rgba(138,43,226,0.5), 0 0 24px rgba(138,43,226,0.2)" : "none",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pt-3 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "columns-2 gap-2", children: GRID_ITEMS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(MasonryItem, { item, index: i }, item.id)) }) })
  ] });
}
const AI_STYLES = [
  "Cyberpunk",
...
`;
function IgniteTab() {
  const [selectedStyle, setSelectedStyle] = reactExports.useState("Cyberpunk");
  const [isFlashed, setIsFlashed] = reactExports.useState(false);
  const [flipCount, setFlipCount] = reactExports.useState(0);
  ...
  const handleSparkTap = async () => {
    ...
    try {
      ...
      ue.success("Spark created successfully!", {
        description: `${selectedStyle} style generated.`,
        duration: 3e3
      });
    } catch (err) {
      const msg = err instanceof Error ? err.message : "Failed to generate Spark. Try again.";
      ue.error(msg);
    } finally {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: scanlineKeyframes }),
    isFlashed && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      ...
                      color: "#c084fc",
                      textShadow: "0 0 16px rgba(138,43,226,0.9), 0 0 32px rgba(138,43,226,0.4)"
                    },
                    children: "IGNITE"
                  }
                ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-h-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-2 flex-shrink-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                  ...
                  !isGenerating && !generatedImageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      style: {
                        ...
                        border: "1px solid rgba(138,43,226,0.35)",
                        boxShadow: "inset 0 0 40px rgba(138,43,226,0.08), 0 0 20px rgba(138,43,226,0.1)",
                        cursor: "pointer"
                      },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    "div",
                    {
                      ...
                      style: {
                        background: "rgba(10,5,20,0.95)",
                        border: generatedImageUrl ? "1px solid rgba(138,43,226,0.6)" : "1px solid rgba(138,43,226,0.35)",
                        boxShadow: generatedImageUrl ? "inset 0 0 40px rgba(138,43,226,0.12), 0 0 30px rgba(138,43,226,0.2)" : "inset 0 0 40px rgba(138,43,226,0.08), 0 0 20px rgba(138,43,226,0.1)"
                      },
                      children: isGenerating ? (
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 z-10", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center", children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                "svg",
                                {
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Generating Spark" }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "circle",
                                      {
                                        cx: "24",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row gap-2 py-2 overflow-x-auto scrollbar-hide flex-shrink-0", children: AI_STYLES.map((style2) => {
                    const isActive = selectedStyle === style2;
                    const styleId = style2.toLowerCase().replace(/\s+/g, "-");
                    return /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        ...
                        style: {
                          fontFamily: "Inter, sans-serif",
                          background: isActive ? "#8A2BE2" : "rgba(138,43,226,0.07)",
                          border: isActive ? "1px solid #8A2BE2" : "1px solid rgba(138,43,226,0.4)",
                          color: isActive ? "#ffffff" : "#9ca3af",
                          boxShadow: isActive ? "0 0 12px rgba(138,43,226,0.6), 0 0 24px rgba(138,43,226,0.2)" : "none",
                          fontWeight: isActive ? 600 : 400
                        },
                        children: style2
                      },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-h-0 px-3 pt-2 pb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-2 flex-shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    background: "radial-gradient(ellipse at 50% 30%, rgba(20,20,30,0.95) 0%, rgba(5,5,10,0.98) 100%)",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 left-3 pointer-events-none", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 right-3 pointer-events-none flex flex-col items-end", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 left-3 pointer-events-none flex flex-col justify-end", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 right-3 pointer-events-none flex flex-col items-end justify-end", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-5 h-5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full px-8 pb-1 flex-shrink-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          style: {
                            ...
                            boxShadow: "0 0 0 2px rgba(80,80,100,0.6), 0 4px 20px rgba(0,0,0,0.5)"
                          },
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
...
const conversations = [
  {
    ...
    gradientFrom: "#8A2BE2",
    gradientTo: "#6F00FF",
    lastMessage: "Your aesthetic just evolved 🌐 want me to remix your latest post?",
    timestamp: "just now",
    isAiTwin: true,
    isUnread: true
  },
...
function ActiveTwinAvatar({ twin }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1.5 flex-shrink-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: twin.initials
          }
        )
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        className: "text-[10px] text-gray-300 truncate max-w-[54px] text-center",
        style: { fontFamily: "Inter, sans-serif" },
        children: twin.username
      }
    ) })
  ] });
}
    ...
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-[13px] truncate ${conv.isUnread ? "font-bold text-white" : "font-semibold text-gray-200"}`,
                style: { fontFamily: "Outfit, sans-serif" },
                children: conv.username
              }
            ),
            conv.isAiTwin && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-2.5 h-2.5", style: { color: "#8A2BE2" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `text-[12px] truncate leading-snug ${conv.isUnread ? "font-semibold text-gray-100" : "text-gray-500"}`,
              style: { fontFamily: "Inter, sans-serif" },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-1.5 flex-shrink-0", children: [
          ...
          conv.isUnread && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                width: "6px",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pt-4 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h1",
      {
        ...
        style: {
          fontFamily: "Syncopate, sans-serif",
          color: "#8A2BE2",
          textShadow: "0 0 12px rgba(138,43,226,0.6), 0 0 24px rgba(138,43,226,0.25)"
        },
        children: "Nexus"
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-3 border-b border-gray-800/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: "text-[10px] font-semibold tracking-[0.18em] uppercase text-gray-500",
            style: { fontFamily: "Outfit, sans-serif" },
            children: "Active Twins"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: activeTwins.map((twin) => /* @__PURE__ */ jsxRuntimeExports.jsx(ActiveTwinAvatar, { twin }, twin.id))
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 pt-3 pb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: "text-[10px] font-semibold tracking-[0.18em] uppercase text-gray-500",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "nexus.list", className: "flex flex-col pb-4", children: conversations.map((conv, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ConversationRow, { conv, index: i }, conv.id)) })
    ] })
  ] });
}
const filterTabs = [
...
function TwinTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "linear-gradient(180deg, #050508 0%, #0a0514 60%, #050508 100%)"
      },
      "data-ocid": "twin.page",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center pt-7 pb-4 px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                height: 96,
                borderRadius: "50%",
                background: "linear-gradient(135deg, #8A2BE2 0%, #6F00FF 50%, #8A2BE2 100%)",
                padding: 2
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    ...
                    height: "100%",
                    borderRadius: "50%",
                    background: "radial-gradient(circle at 35% 30%, rgba(220,180,255,0.6) 0%, rgba(138,43,226,0.8) 28%, rgba(80,0,160,0.9) 55%, rgba(20,5,40,1) 80%, rgba(5,0,15,1) 100%)",
                    display: "flex",
                    alignItems: "center",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                boxShadow: "0 0 10px rgba(138,43,226,0.35), inset 0 0 8px rgba(138,43,226,0.08)"
              },
              children: "AI Twin \\ud83e\\udd16"
            }
          )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            ].map((stat, i, arr) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  style: {
                    ...
                    fontWeight: 700,
                    color: "#8A2BE2",
                    textShadow: "0 0 10px rgba(138,43,226,0.7), 0 0 20px rgba(138,43,226,0.3)",
                    letterSpacing: "0.12em",
                    marginBottom: 10
                  },
                  children: "TWIN PERSONA"
                }
              ),
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    border: isActive ? "1px solid #8A2BE2" : "1px solid rgba(138,43,226,0.25)",
                    background: isActive ? "linear-gradient(135deg, #8A2BE2 0%, #6F00FF 100%)" : "transparent",
                    color: isActive ? "#ffffff" : "rgba(160,155,185,0.85)",
                    boxShadow: isActive ? "0 0 14px rgba(138,43,226,0.6), 0 0 28px rgba(138,43,226,0.25)" : "none"
                  },
                  children: tab.label
                },
                tab.id
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "data-ocid": "twin.list",
            children: gridItems.map((item, position) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        position: "absolute",
                        inset: 0,
                        background: "radial-gradient(ellipse at 30% 20%, rgba(138,43,226,0.08) 0%, transparent 60%), linear-gradient(180deg, rgba(138,43,226,0.04) 0%, transparent 40%)",
                        pointerEvents: "none"
                      }
                    }
                  ),
...
const posts = [
  ...
  },
  {
    ...
    caption: "She exists between signals and silence. AI breathes life into dreams.",
...
function StoryItem({ story }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1.5 flex-shrink-0", children: [
    isYourStory ? (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "w-7 h-7 text-gray-500" })
        }
      )
    ) : (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: story.isAiTwin ? "linear-gradient(135deg, #8A2BE2, #6F00FF, #00eaff)" : "linear-gradient(135deg, #8A2BE2, #6F00FF)",
            boxShadow: story.isAiTwin ? "0 0 14px rgba(138,43,226,0.6), 0 0 28px rgba(111,0,255,0.3)" : "0 0 8px rgba(138,43,226,0.35)"
          },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full rounded-full overflow-hidden bg-black", children: story.avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: story.avatarUrl,
              alt: story.name,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-center text-gray-400 font-inter truncate max-w-[60px]", children: isYourStory ? "Your Story" : story.name }),
    story.isAiTwin && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Coding Aura" })
        ]
      }
    )
  ] });
}
function PostCard({ post, index: index2 }) {
  const [pulsed, setPulsed] = reactExports.useState(false);
  const [saved, setSaved] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      "data-ocid": `vibe.item.${index2 + 1}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 pt-4 pb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-outfit font-semibold text-[14px] leading-tight text-white", children: "akhilesh" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-[12px] leading-tight text-gray-400", children: "@akhilesh" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              "data-ocid": `vibe.post.options.${index2 + 1}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Enhanced by Pulse AI" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              {
                type: "button",
                "data-ocid": `vibe.pulse.button.${index2 + 1}`,
                onClick: () => setPulsed((v2) => !v2),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Heart,
                    {
                      ...
                      style: {
                        color: pulsed ? "#ff4d6d" : void 0,
                        fill: pulsed ? "#ff4d6d" : "none"
                      },
                      color: pulsed ? "#ff4d6d" : "#9ca3af"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 font-inter ml-0.5", children: formatCount(post.pulseCount + (pulsed ? 1 : 0)) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              {
                type: "button",
                "data-ocid": `vibe.echo.button.${index2 + 1}`,
                className: "flex items-center gap-1 bg-transparent border-0 p-0 hover:opacity-80 transition-opacity",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-5 h-5 text-gray-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 font-inter ml-0.5", children: formatCount(post.echoCount) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              {
                type: "button",
                "data-ocid": `vibe.remix.button.${index2 + 1}`,
                className: "flex items-center gap-1 bg-transparent border-0 p-0 hover:opacity-80 transition-opacity",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(WandSparkles, { className: "w-5 h-5 text-gray-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 font-inter ml-0.5", children: formatCount(post.remixCount) })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              {
                type: "button",
                "data-ocid": `vibe.share.button.${index2 + 1}`,
                className: "flex items-center gap-1 bg-transparent border-0 p-0 hover:opacity-80 transition-opacity",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "w-5 h-5 text-gray-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 font-inter ml-0.5", children: formatCount(post.shareCount) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              {
                type: "button",
                "data-ocid": `vibe.save.button.${index2 + 1}`,
                onClick: () => setSaved((v2) => !v2),
                className: "flex items-center gap-1 bg-transparent border-0 p-0 transition-all duration-200 hover:scale-110",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Bookmark,
                    {
                      className: "w-5 h-5 transition-colors duration-200",
                      style: {
                        color: saved ? "#8A2BE2" : void 0,
                        fill: saved ? "#8A2BE2" : "none"
                      },
                      color: saved ? "#8A2BE2" : "#9ca3af"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 font-inter ml-0.5", children: formatCount(post.saveCount + (saved ? 1 : 0)) })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-inter text-gray-300 leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-white font-outfit", children: [
              "akhilesh",
              " "
            ] }),
            post.caption
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1", children: post.hashtags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-600 font-inter mt-1", children: post.timestamp })
        ] })
      ]
    }
  );
...
function VibeTab() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-gray-800/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row gap-4 px-4 py-3 overflow-x-auto scrollbar-hide", children: stories.map((story) => /* @__PURE__ */ jsxRuntimeExports.jsx(StoryItem, { story }, story.id)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-2", children: posts.map((post, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PostCard, { post, index: i }, post.id)) })
  ] });
}
const NavButton = ({
  id,
    ...
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Icon2,
          {
            className: `w-6 h-6 mb-1 transition-all duration-300 ${isActive ? "text-[#8A2BE2] drop-shadow-[0_0_10px_rgba(138,43,226,0.8)]" : "text-gray-500 hover:text-gray-300"}`
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `text-[10px] font-medium transition-all ${isActive ? "text-[#8A2BE2] drop-shadow-[0_0_5px_#8A2BE2]" : "text-gray-500"}`,
            children: id
          }
        )
      ]
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(135deg, rgba(20,10,30,0.97) 0%, rgba(10,5,20,0.98) 100%)",
            boxShadow: "0 8px 32px rgba(138,43,226,0.25), 0 2px 8px rgba(0,0,0,0.8), inset 0 1px 0 rgba(138,43,226,0.15)",
            backdropFilter: "blur(20px)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-[#8A2BE2]/20", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-[#8A2BE2]/60 bg-[#8A2BE2]/10 px-2 py-0.5 rounded-full", children: [
                notifications.length,
                " new"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-[#8A2BE2]/10", children: notifications.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                ...
                onMouseEnter: (e) => {
                  ...
                  e.currentTarget.style.boxShadow = "inset 3px 0 0 #8A2BE2";
                },
                onMouseLeave: (e) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-gray-500 mt-0.5", children: n.time })
                  ] })
                ]
              },
              n.id
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2.5 border-t border-[#8A2BE2]/10 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
...
function MainLayout() {
  const [activeTab, setActiveTab] = reactExports.useState("Vibe");
  const [notifOpen, setNotifOpen] = reactExports.useState(false);
  const renderTabContent = () => {
    switch (activeTab) {
      case "Vibe":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(VibeTab, {});
      case "Explore":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ExploreTab, {});
      case "Ignite":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(IgniteTab, {});
      case "Nexus":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(NexusTab, {});
      case "Twin":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(TwinTab, {});
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "h1",
          {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[390px] h-screen bg-black text-white flex flex-col font-sans relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "absolute top-0 w-full h-16 bg-[#0a0a0a]/90 backdrop-blur-md border-b border-gray-800 flex items-center justify-between px-4 z-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            "aria-label": "Pulse Wave logo",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Pulse Wave" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 12h4l3-9 5 18 3-9h5" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `relative cursor-pointer transition-all duration-200 bg-transparent border-0 p-1.5 rounded-full ${notifOpen ? "text-[#8A2BE2] drop-shadow-[0_0_10px_rgba(138,43,226,0.7)]" : "hover:opacity-80"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Bell,
              {
                className: `w-6 h-6 transition-colors duration-200 ${notifOpen ? "text-[#8A2BE2]" : "text-gray-300"}`
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-0.5 -right-0.5 text-[10px]", children: "✨" })
          ]
        }
      ),
      notifOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationDropdown, { onClose: () => setNotifOpen(false) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "main",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "absolute bottom-0 w-full h-20 bg-[#0a0a0a]/95 backdrop-blur-lg border-t border-gray-800 flex items-center justify-around px-2 z-50 rounded-t-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        NavButton,
        {
          id: "Vibe",
        ...
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300 border-2 ${activeTab === "Ignite" ? "bg-black border-[#8A2BE2] shadow-[0_0_20px_rgba(138,43,226,0.8)]" : "bg-gray-900 border-gray-700 hover:border-[#8A2BE2]"}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Zap,
                  {
                    className: `w-6 h-6 ${activeTab === "Ignite" ? "text-[#8A2BE2] drop-shadow-[0_0_8px_#8A2BE2]" : "text-gray-400"}`
                  }
                )
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-[10px] mt-1 font-medium transition-all ${activeTab === "Ignite" ? "text-[#8A2BE2] drop-shadow-[0_0_5px_#8A2BE2]" : "text-gray-500"}`,
                children: "Ignite"
              }
            )
          ]
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0 pointer-events-none",
            style: {
              background: "radial-gradient(ellipse 60% 40% at 50% 50%, rgba(138,43,226,0.12) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col items-center gap-6 animate-fade-in-up", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(PulseWaveLogo, { size: "large" }),
...
function App() {
  ...
  function handleAuthSuccess() {
    ue.success("Welcome to the Nexus!", {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                ...
                boxShadow: "0 0 0 1px rgba(138,43,226,0.08), 0 0 80px rgba(138,43,226,0.05), 0 25px 80px rgba(0,0,0,0.8)"
              },
              children: [
                screen === "splash" && /* @__PURE__ */ jsxRuntimeExports.jsx(SplashScreen, { onComplete: () => setScreen("auth") }),
                screen === "auth" && /* @__PURE__ */ jsxRuntimeExports.jsx(AuthScreen, { onSuccess: handleAuthSuccess }),
                screen === "main" && /* @__PURE__ */ jsxRuntimeExports.jsx(MainLayout, {})
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Toaster,
            {
              ...
              toastOptions: {
                style: {
                  ...
                  fontFamily: "Inter, sans-serif",
                  fontSize: "13px",
                  boxShadow: "0 0 20px rgba(138,43,226,0.2), 0 8px 32px rgba(0,0,0,0.6)"
                },
                classNames: {
                  title: "font-semibold",
...
Service({
  ...
  "getUserProfile": Func([UserId], [UserProfile], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "login": Func([Username, Password], [UserId], []),
  "register": Func([Username, Password], [], []),
  "saveCallerUserProfile": Func([Text], [], [])
});
